...
const dashboardImageData = await readFile(join(process.cwd(), "media/default/default-og.png"), "base64");
const dashboardImageSrc = `data:image/png;base64,${dashboardImageData}`;
