        ...
        <div className="space-y-4">
          <div className="relative flex aspect-8/5 w-full max-w-100 flex-col justify-between overflow-hidden rounded-xl bg-primary p-6">
            ...
            <div className="space-y-1">
              <p className="font-mono text-lg text-primary-foreground/90 tracking-[0.15em]">•••• •••• •••• 2301</p>
            </div>
            ...
            <div className="flex items-end justify-between">
              ...
              <SimpleIcon icon={siMastercard} className="size-10 fill-primary-foreground/80" />
            </div>
          </div>
