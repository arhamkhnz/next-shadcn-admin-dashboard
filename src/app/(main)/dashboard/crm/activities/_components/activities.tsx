...
function applyFilters(params: {
  ...
  switch (params.view) {
    ...
    case "upcoming":
      ...
      break;
    case "due-today":
      result = result.filter((a) => getScheduleState(a, today) === "Due Today");
      break;
    case "overdue":
      result = result.filter((a) => getScheduleState(a, today) === "Overdue");
      break;
    case "completed":
  ...
  if (params.search) {
    ...
    result = result.filter((a) => buildSearchHaystack(a).includes(q));
  }
...
export function Activities() {
  ...
  const [sorting, setSorting] = React.useState<SortingState>([{ id: "scheduled", desc: false }]);
