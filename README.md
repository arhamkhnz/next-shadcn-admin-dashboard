...
A modern admin dashboard template using Next.js 15 with App Routing, TypeScript, and Shadcn UI.

<img src="https://github.com/arhamkhnz/next-shadcn-admin-dashboard/blob/main/media/dashboard-lg.png?version=5" alt="Dashboard Screenshot" width="100%">
